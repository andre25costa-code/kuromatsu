...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "sipeed/kuromatsu",
			wantOwner:    "sipeed",
			wantRepoName: "kuromatsu",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			name:         "owner/repo with subpath",
			repo:         "sipeed/kuromatsu/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "kuromatsu",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/kuromatsu/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "kuromatsu",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/sipeed/kuromatsu/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "kuromatsu",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/kuromatsu",
			wantOwner:    "sipeed",
			wantRepoName: "kuromatsu",
			wantRef:      "main",
			wantSubPath:  "",
		...
		},
		{
			...
			repo:           "https://gitlab.com/sipeed/kuromatsu/-/tree/main/skills/test",
			wantErr:        true,
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "kuromatsu")
	...
	err = installer.InstallFromGitHub(context.Background(), "sipeed/kuromatsu")
	if err == nil {
