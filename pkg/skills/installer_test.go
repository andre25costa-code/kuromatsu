...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "https://github.com/andre25costa-code/kuromatsu/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/andre25costa-code/kuromatsu/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/andre25costa-code/kuromatsu",
			wantOwner:    "sipeed",
			wantRepoName: "picoclaw",
			wantRef:      "main",
			wantSubPath:  "",
