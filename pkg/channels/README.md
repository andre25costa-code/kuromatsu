...
import (
    "github.com/andre25costa-code/kuromatsu/pkg/bus"
    "github.com/andre25costa-code/kuromatsu/pkg/channels"     // Reference parent package
    "github.com/andre25costa-code/kuromatsu/pkg/config"
    "github.com/andre25costa-code/kuromatsu/pkg/identity"      // New
    "github.com/andre25costa-code/kuromatsu/pkg/media"          // New (if media support needed)
)
```
...
import (
    _ "github.com/andre25costa-code/kuromatsu/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/andre25costa-code/kuromatsu/pkg/channels/discord"
    _ "github.com/andre25costa-code/kuromatsu/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/andre25costa-code/kuromatsu/pkg/channels"
    "github.com/andre25costa-code/kuromatsu/pkg/config"
    "github.com/andre25costa-code/kuromatsu/pkg/identity"
...
// cmd/picoclaw/internal/gateway/helpers.go
import (
    _ "github.com/andre25costa-code/kuromatsu/pkg/channels/matrix"
)
```
