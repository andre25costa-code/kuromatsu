...
import (
    "github.com/andre25costa-code/kuromatsu/pkg/bus"
    "github.com/andre25costa-code/kuromatsu/pkg/channels"     // 引用父包
    "github.com/andre25costa-code/kuromatsu/pkg/config"
    "github.com/andre25costa-code/kuromatsu/pkg/identity"      // 新增
    "github.com/andre25costa-code/kuromatsu/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/andre25costa-code/kuromatsu/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/andre25costa-code/kuromatsu/pkg/channels/discord"
    _ "github.com/andre25costa-code/kuromatsu/pkg/channels/your_new_channel"  // 新增
)
```
