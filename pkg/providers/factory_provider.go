...
import (
	...
	anthropicmessages "github.com/andre25costa-code/kuromatsu/pkg/providers/anthropic_messages"
	"github.com/andre25costa-code/kuromatsu/pkg/providers/azure"
	"github.com/andre25costa-code/kuromatsu/pkg/providers/bedrock"
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: kuromatsu auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: kuromatsu auth login --provider openai")
	}
...
func CreateProviderFromConfig(cfg *config.ModelConfig) (LLMProvider, string, error) {
	...
	if userAgent == "" {
		userAgent = fmt.Sprintf("Kuromatsu/%s", config.Version)
	}
