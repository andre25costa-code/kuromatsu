...
import (
	...
	anthropicprovider "github.com/andre25costa-code/kuromatsu/pkg/providers/anthropic"
)
...
func CreateClaudeTokenSource(getCredential func(string) (*auth.AuthCredential, error)) func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: kuromatsu auth login --provider anthropic")
		}
