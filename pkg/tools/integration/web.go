...
const (
	...
	userAgentHonest = "kuromatsu/%s (+https://github.com/andre25costa-code/kuromatsu; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(
	...
	// Format results in standard Kuromatsu format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies kuromatsu, which some
