...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/kuromatsu_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("KUROMATSU_LOG_FILE", tmpFile)
	defer os.Unsetenv("KUROMATSU_LOG_FILE")
	...
	os.Setenv("KUROMATSU_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
...
func TestConfigureFromEnvNoEnv(t *testing.T) {
	os.Unsetenv("KUROMATSU_LOG_FILE")
	ConfigureFromEnv()
}
