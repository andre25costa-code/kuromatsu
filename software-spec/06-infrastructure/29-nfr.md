...
| NFR-002 | Performance | Geração ≥ **4 tokens/s** com `n_ctx=2048` na máquina alvo (AMD EPYC 7551 "Naples"/Zen1, 1 OCPU — Oracle `VM.Standard.E2.1.Micro`, ver A1) | `cmd/nativebench` (3 prompts fixos, média) |
