...
Orçamento de RAM que sustenta NFR-001 (derivado, validar no E7):
modelo mmap 237 MB + KV q8_0 @2048 ≈ 118 MB + buffers de compute ~60 MB + Go/agente
200–300 MB ⇒ pico estimado 650–720 MB, com `GOMEMLIMIT=650MiB` segurando o heap Go.
